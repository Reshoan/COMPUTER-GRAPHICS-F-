...
// Lanes (y positions). index 0 = top (slow), 1 = middle (slow), 2 = bottom (fast)
...
static int rickshawLane = 1;     // start in middle lane (slow)
static float rickshawY = laneY[1];
static float rickshawTargetY = laneY[1];
...
static int carLane = 2; // start in bottom lane (fast)
static float carY = laneY[2];
static float carTargetY = laneY[2];
